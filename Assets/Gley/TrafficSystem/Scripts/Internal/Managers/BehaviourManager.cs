...
namespace Gley.TrafficSystem.Internal
{
    public class BehaviourManager : UrbanSystem.Internal.IDestroyable
    {
        ...
        public void SetVehicleBehaviours(int vehicleIndex, VehicleBehaviour[] vehicleBehaviours)
        {
            ...
            {
                if (!_supportedBehaviours[vehicleIndex].ContainsKey(vehicleBehaviours[i].Name))
                {
                    _supportedBehaviours[vehicleIndex].Add(vehicleBehaviours[i].Name, vehicleBehaviours[i]);
